# Generated by Powerlevel10k configuration wizard on 2021-10-30 at 02:44 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=023
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_VERSION_SHOW_ON_COMMAND='tfplan|tfapply|terraform|tf'

  #############[ kubecontext: current kubernetes context (https://kubernetes.io/) ]#############
  # Show kubecontext only when the the command you are typing invokes one of these tools.
  # Tip: Remove the next line to always show kubecontext.
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='terraform|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern'
  ...
  typeset -g POWERLEVEL9K_GCLOUD_SHOW_ON_COMMAND='terraform|gcloud|gcs'
  # Google cloud color.
